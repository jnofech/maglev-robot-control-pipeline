function [ry,ffilter]=ifilter_noplot(ix,iy,icenter,iwidth,ishape,imode,ifilt)
...
% figure(1)
[ry,ffilter]=RedrawFourierFilter(x,y,CENTER,WIDTH,SHAPE,PLOTMODE,FILTERMODE,YMODE,XMODE);
...
if ischar(key),
  switch double(key),
    ...
    case 104
        ...
        [ry,ffilter]=RedrawFourierFilter(x,y,length(y)/2,WIDTH,SHAPE,PLOTMODE,FILTERMODE,YMODE,XMODE);
    case 108
          % When 'L' is pressed, makes low=pass filter
          FILTERMODE='Low-pass';
          [ry,ffilter]=RedrawFourierFilter(x,y,0,WIDTH,SHAPE,PLOTMODE,FILTERMODE,YMODE,XMODE);
    case 99
...
function [ry,ffilter]=RedrawFourierFilter(xvector,yvector,centerfrequency,filterwidth,filtershape,mode,FILTERMODE,YMODE,XMODE)
