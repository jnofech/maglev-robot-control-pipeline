function [file_data] = dataset_generator(fname,mode_rawdata,mode_accel_method,mode_accel_filtering,lowpass_cutoff_hz,data_keep_ratio,extrap_mode)
...
%
    ...
    data = table(x_starts,y_starts,x_finals,y_finals, ...
                x_finals_extrap,y_finals_extrap, ...
                x_velocs,y_velocs, ...
